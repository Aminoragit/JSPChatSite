...
public class UserUpdateServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//현재 userID와 현재 접속중이 Session의 userID가 동일한지 확인
		...
		if(userID == null || userID.equals("") || userPassword == null || userPassword.equals("")|| userPassword1 == null || userPassword1.equals("") || userPassword2 == null || userPassword2.equals("") || 
		...
		int result1 =new UserDAO().login(userID, userPassword);
		if(result1 == 2) {
			request.getSession().setAttribute("messageType", "오류 메시지");
			request.getSession().setAttribute("messageContent", "현재 유저의 비밀번호가 다릅니다.");
			response.sendRedirect("update.jsp");
			return;
		}
